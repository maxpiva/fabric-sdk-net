...
namespace Hyperledger.Fabric.SDK.Idemix
{
     ...
     */
    public interface INonRevocationProver
    {
        /**
         ...
         * @return proof
         */
        byte[] GetFSContribution(BIG rh, BIG rRh, CredentialRevocationInformation cri);
         ...
         * @return proof
         */
        NonRevocationProof GetNonRevocationProof(BIG challenge);
    }

    public static class NonRevocationProver
    {
        /**
        ...
        public static INonRevocationProver GetNonRevocationProver(RevocationAlgorithm algorithm)
        {
            ...
            switch (algorithm)
            {
                ...
                default:
                    ...
                    throw new ArgumentException("Revocation algorithm " + algorithm.ToString() + " not supported");
            }
        }
    }
}