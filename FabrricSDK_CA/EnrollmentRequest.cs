...
namespace Hyperledger.Fabric_CA.SDK
{
    ...
    public class EnrollmentRequest
    {
        ...
        private Dictionary<string, AttrReq> attrreqs = null; //new HashMap<>();
 ...
 * @param keypair
 */
        public AsymmetricAlgorithm KeyPair { get; set; } = null;
        ...
        {
            private EnrollmentRequest parent;
            ...
            public AttrReq HavingOptional(bool optional)
            {
                Optional = optional;
                return this;
            }
